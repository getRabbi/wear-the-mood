...
void main() {
  ...
  group('Credits', () {
    ...
    test('enhanceCost parses from the API and defaults to one credit', () {
      ...
      // Whatever the server says, even a value this build never ships.
      expect(fromApi.enhanceCost, 2);
      // Absent field falls back to the shipped price: one credit. Every
      // render is one now — AI Enhance costing four leaked FASHN's own
      // per-result pricing onto the person paying.
