...
const NAV: NavItem[] = [
  ...
  { label: "Products", href: "/products", permission: "view_catalog" },
  { label: "Merchants", href: "/merchants", permission: "view_catalog" },
  { label: "Newsroom", href: "/newsroom", permission: "view_newsroom" },
  { label: "Automation", href: "/automation", permission: "view_catalog" },
