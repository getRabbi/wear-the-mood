...
__all__ = ["WeatherProvider", "WeatherSnapshot", "get_weather_provider"]
...
def get_weather_provider() -> WeatherProvider:
    ...
    if get_settings().weather_provider.lower() == "stub":
        return StubWeatherProvider()
    from app.services.weather.open_meteo import OpenMeteoWeatherProvider

    return OpenMeteoWeatherProvider(base_url=get_settings().open_meteo_base_url)
